                ...
                {[...(players || [])]
                  ...
                  .map((p) => (
                    ...
                    >
                      ...
                      <td className="px-3 py-3 text-center tabular-nums text-[var(--accent)]">{p.runs_scored}</td>
                      <td className="px-3 py-3 text-center tabular-nums text-[var(--surface)]">{p.wickets_taken}</td>
                      <td className="px-3 py-3 text-center font-mono text-[var(--text-primary)]">{p.batting_performance}</td>
                      <td className="px-3 py-3 text-center font-mono text-[var(--text-primary)]">{p.bowling_performance}</td>
                      <td className="px-3 py-3 text-center font-mono text-[var(--accent)]">{p.context_weight}×</td>
                      <td className="px-3 py-3 text-center font-mono text-[var(--accent-strong)]">{p.pressure_index}×</td>
                      <td className="px-3 py-3 text-center font-mono text-[var(--text-primary)]">{p.raw_impact}</td>
                      <td className="px-3 py-3 text-center font-mono font-bold text-[var(--accent-strong)]">
